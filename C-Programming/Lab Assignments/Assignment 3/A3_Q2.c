...
int main()
{
    ...
    printf("Value of the first variable is......%d",a);     //Printing the user input value of 1st variable.
    printf("Value of the second variable is......%d",b);     //Printing the user input value of 2nd variable.
    return 0;
}